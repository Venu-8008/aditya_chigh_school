        ...
        <section className="py-20 bg-cream">
            <div className="max-w-[1140px] mx-auto px-4">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                                <div className="text-center text-white transform group-hover:scale-110 transition-transform duration-300">
                                    <h3 className="text-2xl font-semibold mb-2" style={{ fontFamily: 'Noto Serif, serif' }}>
                                        {item.title}
                                    </h3>
                                    <p className="text-sm text-gold font-semibold" style={{ fontFamily: 'Poppins, sans-serif' }}>
                                        {item.category}
                                    </p>
                                </div>
                            </div>
                ...
                <div className="text-center mt-12">
                    <button className="bg-primary text-white px-8 py-3 rounded text-[15px] font-medium hover:bg-green-800 transition-all hover:scale-105">
                        View Full Gallery
                    </button>
                </div>
            </div>
